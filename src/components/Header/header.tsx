  ...
  return (
    <header className="bg-black text-[#F59F23] px-4 md:px-6 fixed top-0 left-0 right-0 z-50 shadow-lg h-[72px]">
      <div className="flex justify-between items-center gap-4 h-full">
        ...
        <Button
          asChild
          className="hidden lg:inline-flex rounded-xl bg-[#F59F23] text-black px-3 md:px-4 py-2 
          hover:bg-[#F9c57b] transition text-xs md:text-sm font-bold whitespace-nowrap"
        >
          {header?.ButtonLink ? (
